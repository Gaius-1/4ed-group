...
const Contact = () => {
  ...
  return (
    <Layouts>
        <PageBanner pageTitle={"Contact Us"} pageDesc={"Solutions Beyond Expectations.."} />
        ...
        <section className="gap contact-form-2">
            ...
            <div className="row">
                ...
                <div className="bio">
                    <div className="data">
                        <figure>
                            <img className="author" src="/img/director.png" alt="Bio Image" />
                        </figure>
                        <h3>Kingsley Ocquaye</h3>
                        <p>Director of SM Engineering</p>
                        <figure>
                ...
                <div className="info">
                    <ul className="contact">
                        <li>
                            ...
                            <div>
                                <h3>Address:</h3>
                                <p>PS Global Estates, Community 25, Tema</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <h3>Telephone:</h3>
                                <p>Tel:   (+233) 558 671 351</p>
                                <p>Fax:  (+233) 243 191 876</p>
                            </div>
                        </li>
                        <li>
